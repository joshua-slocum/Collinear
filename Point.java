...
public class Point implements Comparable<Point> {
    ...
    public double slopeTo(Point that) {
        ...
        // currently don't have a check for the case where the y values are
        // equal, as it should return zero in that case and the below formula
        // should do that as we have already checked the denominator for divide
        // by zero issues
        // use a widening cast to double as it is integer division
    ...
    public int compareTo(Point that) {
        ...
        if (this.y > that.y) return 1;
        // Don't need to check if this.y == that.y because it must be true to
        // get to this statement, so we omit it for brevity
